...
export function Step4Localizacao({ onNext }: { onNext: () => void }) {
  ...
  const [bairro, setBairro] = useState(homeEquity.bairro || "")
  const [cidade, setCidade] = useState(homeEquity.cidade || "")
  const [uf, setUf] = useState(homeEquity.uf || "")
    ...
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground text-sm">
          Informe o CEP para identificar a localização.
        </p>
      </div>
